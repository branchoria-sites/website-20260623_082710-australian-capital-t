...
child_basenames:
- New_South_Wales_f92f26_modern_checks_1086a1_index
...
show_ads: true
description: Smartphones created more footage, but public tracking tools have also made many sightings easier to test.
hero_summary: Smartphones created more footage, but public tracking tools have also made many sightings easier to test.
layout: default
permalink: /modern-checks/
sidebar_expanded_urls:
- /what-makes-new-south-wales-ufo-reports/
nav_short_title: Modern Checks
title: Can Modern Tools Solve Old Style UFO Reports?
title_full: Can Modern Tools Solve Old Style UFO Reports?
display_title_short: Modern Checks
display_title: Modern Checks
heading_title: Can Modern Tools Solve Old Style UFO Reports?
page_heading_title: Can Modern Tools Solve Old Style UFO Reports?
source_count: 117
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Did Parramatta Have a UFO Story Before Flying Saucers?
header:
  og_image: /assets/images/New_South_Wales_f92f26_modern_checks_1086a1-overview-social.jpg
  preview_image: /assets/images/New_South_Wales_f92f26_modern_checks_1086a1-overview.webp
image: /assets/images/New_South_Wales_f92f26_modern_checks_1086a1-overview-social.jpg
---

## Introduction

Modern checks cannot “solve” every [New South Wales]({{ 'what-makes-new-south-wales-ufo-reports/' | relative_url }}) UFO report, but they have changed the first question investigators should ask. A strange light over Sydney, Newcastle, the Central Coast, the Blue Mountains or northern NSW is no longer judged only from memory, newspaper wording or a shaky phone clip. It can often be compared with aircraft tracks, airport flight paths, satellite predictions, rocket launches, drone rules and astronomical conditions. That matters because many reports that once might have stayed mysterious can now be tested within minutes or hours.


<img src="{{ "/assets/images/New_South_Wales_f92f26_modern_checks_1086a1-overview.webp" | relative_url }}" alt="Overview image for Modern Checks" loading="eager" decoding="sync" fetchpriority="high">
...
Modern reports are different. A witness may have a smartphone video with metadata, a street location, a social media timestamp, and dozens of other people posting from nearby suburbs. At the same time, public tools can show whether an aircraft, satellite, space station pass, Starlink train, meteor shower, drone event or [rocket plume]({{ 'rocket-plume/' | relative_url }}) was visible from that location.
...
1. **Exact date and time**, including whether the phone clock was set correctly.
2. **Observer location**, ideally a suburb, street corner, beach, lookout or GPS point.
3. **Direction faced**, such as west over the Blue Mountains, north-east over the ocean, or south towards Sydney Airport.
4. **Angle above the horizon**, even roughly: low over rooftops, halfway up the sky, or nearly overhead.
5. **Movement**, including whether it crossed the sky, hovered, faded, flashed, split, or changed direction.
6. **Sound**, while remembering that distant aircraft, high-altitude jets and satellites may be silent.
7. **Unedited original media**, not just a compressed social media repost.
...
<img src="{{ "/assets/images/New_South_Wales_f92f26_modern_checks_1086a1-Illustration-3-dark.svg" | relative_url }}" alt="Modern Checks illustration 3" data-theme-src-dark="{{ "/assets/images/New_South_Wales_f92f26_modern_checks_1086a1-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/New_South_Wales_f92f26_modern_checks_1086a1-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
