...
- Australian_Capital_T_2949ba_index
...
show_ads: true
description: The Australian Capital Territory has a smaller UFO history than larger states such as Victoria, South Australia or Western Australia, but it has one...
hero_summary: 'The Australian Capital Territory has a smaller UFO history than larger states such as Victoria, South Australia or Western Australia, but it has one unusually important role: Canberra was both a place of sightings and the administrative centre through which many national UFO records passed.'
layout: default
permalink: /australian-capital-territory/
nav_short_title: Canberra's UFO Files Without the Hype
title: Canberra's UFO Files Without the Hype
title_full: Canberra's UFO Files Without the Hype
display_title_short: Canberra's UFO Files Without the Hype
display_title: Canberra's UFO Files Without the Hype
heading_title: Canberra's UFO Files Without the Hype
...
next_link:
  ...
  short_title: Queensland UFOs
header:
  og_image: /assets/images/Australian_Capital_T_2949ba-overview-social.jpg
  preview_image: /assets/images/Australian_Capital_T_2949ba-overview.webp
image: /assets/images/Australian_Capital_T_2949ba-overview-social.jpg
---
...
That distinction is important for readers. A Canberra UFO page should not pretend the ACT has a Westall-style school incident or a North West Cape-style defence-base legend within its borders. Its value is different: the ACT shows how UFO reports were processed, explained, disputed and filed by a federal system. It also gives one strong local case, the Canberra Airport sighting, where trained aviation observers, official investigation and later sceptical reinterpretation all meet in a compact episode.
...
<img src="{{ "/assets/images/Australian_Capital_T_2949ba-Illustration-2-dark.svg" | relative_url }}" alt="Australian Capital Territory illustration 2" data-theme-src-dark="{{ "/assets/images/Australian_Capital_T_2949ba-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Australian_Capital_T_2949ba-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The most common explanations in Canberra skies
...
<img src="{{ "/assets/images/Australian_Capital_T_2949ba-Illustration-3-dark.svg" | relative_url }}" alt="Australian Capital Territory illustration 3" data-theme-src-dark="{{ "/assets/images/Australian_Capital_T_2949ba-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Australian_Capital_T_2949ba-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What the ACT record really says
