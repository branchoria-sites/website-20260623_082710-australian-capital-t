...
show_ads: true
description: The first public explanation was daylight Venus, but the reported north-east position and witness objections kept doubt alive.
hero_summary: The first public explanation was daylight Venus, but the reported north-east position and witness objections kept doubt alive.
layout: default
permalink: /venus-claim/
sidebar_expanded_urls:
- /australian-capital-territory/
- /airport-case/
nav_short_title: Venus Claim
title: Was the Canberra Object Really Venus?
title_full: Was the Canberra Object Really Venus?
display_title_short: Venus Claim
display_title: Venus Claim
heading_title: Was the Canberra Object Really Venus?
page_heading_title: Was the Canberra Object Really Venus?
source_count: 28
infographic_count: 3
planned_sections:
- What the early newspaper report said
- Why daylight Venus was considered plausible
...
prev_link:
  ...
  heading_title: What The RAAF Record Really Shows
header:
  og_image: /assets/images/Australian_Capital_T_2949ba_canberra_airport_sig_409db1_canberra_venus_claim_5e40ac-Illustration-1-social.jpg
  preview_image: /assets/images/Australian_Capital_T_2949ba_canberra_airport_sig_409db1_canberra_venus_claim_5e40ac-Illustration-1.webp
image: /assets/images/Australian_Capital_T_2949ba_canberra_airport_sig_409db1_canberra_venus_claim_5e40ac-Illustration-1-social.jpg
---
...
At first glance, identifying an unusual object as Venus may sound unconvincing. In reality, Venus has been responsible for many UFO reports around the world because it is by far the brightest planet visible from Earth. Under favourable conditions it can sometimes be seen in daylight, especially by observers who know where to look. Atmospheric effects can also make it appear larger, more luminous or oddly coloured than it really is.

Several factors made the Venus explanation attractive in July 1965:
...
From an investigator's perspective, a bright celestial object is often the simplest explanation for a distant stationary light. If observers misjudge distance and size, a planet can appear far more unusual than it actually is.

The fact that the sighting occurred in daylight did not automatically rule Venus out. Although uncommon, daylight observations of Venus are well documented by astronomers and experienced sky-watchers. This made the explanation scientifically possible rather than inherently absurd.
...
### The reported position in the sky
...
Another problem was the confidence of the observers themselves. Air traffic personnel routinely distinguish aircraft, balloons, planets and atmospheric phenomena. That expertise does not make them infallible, but it raises the evidential bar for any simple misidentification claim.

Sceptics of the Venus explanation therefore argued that multiple aviation witnesses would have been less likely than average members of the public to mistake a bright planet for an unusual aerial object. Supporters of the Venus theory responded that even trained observers can be misled when viewing a bright object without obvious reference points, particularly in daylight conditions.

The disagreement was never decisively resolved because no detailed contemporary witness statements survive publicly in the way they do for some larger Australian UFO cases.


<img src="{{ "/assets/images/Australian_Capital_T_2949ba_canberra_airport_sig_409db1_canberra_venus_claim_5e40ac-Illustration-3-dark.svg" | relative_url }}" alt="Venus Claim illustration 3" data-theme-src-dark="{{ "/assets/images/Australian_Capital_T_2949ba_canberra_airport_sig_409db1_canberra_venus_claim_5e40ac-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Australian_Capital_T_2949ba_canberra_airport_sig_409db1_canberra_venus_claim_5e40ac-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What the Venus debate tells us about the case

The argument over Venus illustrates why the Canberra Airport sighting remains an ambiguous case rather than a solved one.

The Venus explanation had genuine strengths:
...
At the same time, the explanation faced important weaknesses:
